...
<c:if test="${empty notice}">
	<script type="text/javascript">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          <div class="row my-2">
            <h2 class="text-secondary px-5">${notice.num}. ${notice.title}</h2>
          </div>
          <div class="row">
            <div class="col-md-8">
              <div class="clearfix align-content-center">
                ...
                />
                <p>
                  <span class="text-secondary fw-light"> ${notice.regdate} 조회 : ${notice.count} </span>
                </p>
              </div>
            </div>
    ...
    <form id="form-no-param" method="get" action="${root}/notice">
      ...
      <input type="hidden" id="noticeno" name="num" value="${notice.num}">
    </form>
    <script>
